...
export const API_BASE_URL = 'https://code.textmode.art/api/textmode.figlet.js';
export const PACKAGE_LABEL = 'textmode.figlet.js';
export const CHECK_EXAMPLE_SKETCHES = true;
export const API_DOCS_DIR = path.resolve('api/textmode.figlet.js');
